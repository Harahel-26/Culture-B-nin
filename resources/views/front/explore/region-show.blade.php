...
<div class="container py-5">
    ...
    <h1 class="fw-bold mb-2">Région : {{ $region->nom }}</h1>
    <p class="text-muted mb-4">{{ $contenus->total() }} contenus disponibles pour cette région.</p>
    ...
    <div class="row g-4">
        ...
        @empty
            <div class="alert alert-info" role="alert">
                Aucun contenu n'a encore été publié pour la région de {{ $region->nom }}.
            </div>
        @endforelse
    </div>
